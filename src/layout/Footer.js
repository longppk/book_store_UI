    ...
    <FooterStyles className="container">
      <div className="footer-info">
        ...
        <div className="footer-register">
          <input className="footer-email" placeholder="nhập email của bạn" />
      ...
      <div className="footer-static">
        <div className="footer-address">
          ...
          <p className="address-detail">
            Lầu 5, đường 3/2 Quận Ninh Kiều, TP. Cần Thơ Công Ty Cổ Phần Phát
            Hành Sách TP CT - BookHaSa - 62 Lê Lợi, Ninh Kiều, TP. Cần Thơ, Việt
            Nam
          </p>
          <p className="address-detail">
        ...
        <div>
          ...
          <div className="footer-payment">
            <img className="image-payment" src="https://cdn0.fahasa.com/media/wysiwyg/Logo-NCC/vnpost1.png" alt=""/>
            <img className="image-payment" src="https://cdn0.fahasa.com/media/wysiwyg/Logo-NCC/ahamove_logo3.png" alt=""/>
            <img className="image-payment" src="https://cdn0.fahasa.com/media/wysiwyg/Logo-NCC/icon_giao_hang_nhanh1.png" alt=""/>
            <img className="image-payment" src="https://cdn0.fahasa.com/media/wysiwyg/Logo-NCC/icon_snappy1.png" alt=""/>
            <img className="image-payment" src="https://cdn0.fahasa.com/media/wysiwyg/Logo-NCC/Logo_ninjavan.png" alt=""/>
            <img className="image-payment" src="https://cdn0.fahasa.com/media//wysiwyg/Logo-NCC/vnpay_logo.png" alt=""/>
            <img className="image-payment" src="https://cdn0.fahasa.com/media//wysiwyg/Logo-NCC/ZaloPay-logo-130x83.png" alt=""/>
            <img className="image-payment" src="https://cdn0.fahasa.com/media//wysiwyg/Logo-NCC/shopeepay_logo.png" alt=""/>
          </div>
        </div>
      </div>
    </FooterStyles>
